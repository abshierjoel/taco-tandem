...
module Taco.Interface.NodeWithTemplate exposing (..)
...
fragments :
      Fragments decodesTo
      -> SelectionSet decodesTo Taco.Interface.NodeWithTemplate
...
template : SelectionSet decodesTo Taco.Interface.ContentTemplate
 -> SelectionSet (Maybe decodesTo) Taco.Interface.NodeWithTemplate
template object____ =
