...
module Taco.Interface.MenuItemLinkable exposing (..)
...
fragments :
      Fragments decodesTo
      -> SelectionSet decodesTo Taco.Interface.MenuItemLinkable
...
-}
databaseId : SelectionSet Int Taco.Interface.MenuItemLinkable
databaseId =
...
{-| The unique resource identifier path
-}
id : SelectionSet Taco.ScalarCodecs.Id Taco.Interface.MenuItemLinkable
id =
...
{-| The unique resource identifier path
-}
uri : SelectionSet String Taco.Interface.MenuItemLinkable
uri =
