...
postsQuery : String -> String -> SelectionSet (Maybe Response) RootQuery
postsQuery cursor categoryId =
    Query.posts (getPostsOptArgs cursor categoryId) postsSelection


getPostsOptArgs : String -> String -> Query.PostsOptionalArguments -> Query.PostsOptionalArguments
getPostsOptArgs cursor categoryName args =
    ...
    , where_ =
        Graphql.OptionalArgument.Present <|
            Taco.InputObject.buildRootQueryToPostConnectionWhereArgs (\optionals -> { optionals | categoryName = Graphql.OptionalArgument.Present categoryName })
    }


whereArgs : Taco.InputObject.RootQueryToPostConnectionWhereArgs
whereArgs =
    Taco.InputObject.buildRootQueryToPostConnectionWhereArgs identity
